...
public class CleanText {
	...
	private static String removeStopWords(String content) {
		...
		List<String> stopWords = StreamIO.getInstance().getWordLists().getStopWords();// TODO
																						// change
																						// list
																						// hash
																						// set
	...
	public static String removeLegalEntityTypes(String companyName) {
		List<String> legalEntityTypes = StreamIO.getInstance().getWordLists().getLegalEntityTypes();// TODO
																									// change
																									// list
																									// hash																					// set
